...
export function SignInForm() {
  async function onSubmit(formData: FormData) {
    ...
    if (error) {
      return redirect(
        `/admin/sign-in?error=true&message=Não foi possível efetuar o login, tente novamente em alguns instantes.`,
      )
    }

    return redirect(
      `/admin/sign-in?message=Enviamos um e-mail para você. Clique no link para fazer o login.`,
    )
  }
