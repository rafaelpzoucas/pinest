import { readCategoriesByStore } from '@/app/admin/(protected)/(app)/catalog/categories/actions'
import { ProductForm } from '@/app/admin/(protected)/(app)/catalog/products/register/form/form'
    ...
    <div className="flex flex-col gap-4 pb-16">
      ...
      {!categories || categories.length === 0 ? (
        <div className="flex flex-col items-start gap-4">
          ...
          <Link
            href={`/admin/onboarding/products/register/category`}
