...
export function Extras({
  ...
  const handleSaveExtras = (productId: string) => {
    ...
    form.setValue(`purchase_items.${productIndex}.extras`, formattedExtras)
    form.setValue(`purchase_items.${productIndex}.product_price`, totalPrice)
