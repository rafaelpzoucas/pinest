...
} from "@/app/(protected)/(app)/config/(options)/billing/actions";
...
export default async function Payments() {
  ...
  if (!account.details_submitted) {
    const accountLink = await stripe.accountLinks.create({
      ...
      refresh_url: `${process.env.NEXT_PUBLIC_APP_URL}/onboarding/payments/stripe`,
      return_url: `${process.env.NEXT_PUBLIC_APP_URL}/onboarding/payments/stripe`,
