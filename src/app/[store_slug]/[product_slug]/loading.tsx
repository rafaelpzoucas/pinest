      ...
      <div className="w-full max-w-7xl">
        <div className="flex flex-col xl:flex-row xl:gap-12">
          <div className="lg:sticky top-0 w-full max-w-md">
            <Skeleton className="relative w-full aspect-square overflow-hidden border-none rounded-none" />
          </div>

          <section className="mt-6 lg:mt-0 space-y-6 lg:space-y-12 w-full p-4">
